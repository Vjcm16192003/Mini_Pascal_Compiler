...
public class MiniPascalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "PROGRAM", "FUNCTION", "PROCEDURE", "BEGIN", 
			"MAIN", "VAR", "ASSIGN", "END", "READ", "WRITE", "CONSTSTR", "AND", "OR", 
			"NOT", "IF", "THEN", "ELSE", "WHILE", "DO", "FOR", "TO", "REPEAT", "UNTIL", 
			"ID", "NUM", "CONSTCHAR", "STRING_LITERAL", "BOOLEAN", "INT_TYPE", "CHAR_TYPE", 
			"STRING_TYPE", "BOOLEAN_TYPE", "ARRAY_TYPE", "WS", "COMMENT"
		};
	}
